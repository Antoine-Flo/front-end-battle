...
class StorageService {
    ...
    downloadViaUrl(imgName) {
        const storageRef = firebase__WEBPACK_IMPORTED_MODULE_0__["default"].storage().ref();
        storageRef
            .child(imgName)
            .getDownloadURL()
            .then((url) => {
...
class ChallengesComponent {
    constructor(challengesService, storage) {
